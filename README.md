...
Хай, я **фулл-стек разработчик** с уклоном под фронтенд, увлекающийся созданием масштабируемых веб приложений. Мой примерный экспириенс более полугода в **React** и **Nest** разработке.

В настоящее время я сосредоточен на создании своего сервиса потоковой передачи контента по сериалам, **стремясь создать лучшую платформу в снг и дать приятный опыт для узкого круга сообщества.** 
